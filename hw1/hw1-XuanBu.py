...
# import data
cri_17 = pd.read_csv('https://data.cityofchicago.org'
        '/api/views/d62x-nvdr/rows.csv?accessType=DOWNLOAD')
cri_18 = pd.read_csv('https://data.cityofchicago.org'
        '/api/views/3i3m-jwuy/rows.csv?accessType=DOWNLOAD')
...
print("There are {}% blocks of 'Battery' crime with ratio of educated"
    " people that is below the average ratio of educated people."\
    .format(round(uneducated_rate_battery_17*100,2)))
uneducated_rate_battery_18 = \
            describe_edu_in_block_by_crime(df_final_18, 'BATTERY')
print("There are {}% blocks of 'Battery' crime with ratio of"
    " people who finished high school that is below the average"
    " ratio of people who finished high school."\
    .format(round(uneducated_rate_battery_18*100,2)))
...
print("There are {}% blocks of 'Homicide' crime with ratio of educated"
    " people that is below the average ratio of educated people."\
    .format(round(uneducated_rate_homicide_17*100,2)))
uneducated_rate_homicide_18 = \
        describe_edu_in_block_by_crime(df_final_18, 'HOMICIDE')
print("There are {}% blocks of 'Homicide' crime with ratio of"
    " people who finished high school that is below the average"
    " ratio of people who finished high school."\
    .format(round(uneducated_rate_homicide_18*100,2)))
...
print("There are {}% blocks of 'Deceptive Practice' crime with ratio of"
    " educated people that is below the average ratio of educated people."\
    .format(round(uneducated_rate_dp_17*100,2)))
uneducated_rate_dp_18 = \
    describe_edu_in_block_by_crime(df_final_18, 'DECEPTIVE PRACTICE')
print("There are {}% blocks of 'Deceptive Practice' crime with ratio of"
    " people who finished high school that is below the average"
    " ratio of people who finished high school."\
    .format(round(uneducated_rate_dp_18*100,2)))

uneducated_rate_so_17 = \
    describe_edu_in_block_by_crime(df_final_17, 'SEX OFFENSE')
print("There are {}% blocks of 'Sex Offense' crime with ratio of"\
    " educated people that is below the average ratio of educated people."\
    .format(round(uneducated_rate_so_17*100,2)))
uneducated_rate_so_18 = \
    describe_edu_in_block_by_crime(df_final_18, 'SEX OFFENSE')
print("There are {}% blocks of 'Sex Offense' crime with ratio of"
    " people who finished high school that is below the average"
    " ratio of people who finished high school."\
    .format(round(uneducated_rate_so_18*100,2)))
...
print("The change of robbery is {}%.".format(round(change_robbery, 2)))

change_battery = compute_change(cri_17, cri_18, 'BATTERY')
print("The change of battery is {}%.".format(round(change_battery, 2)))

change_burglary = compute_change(cri_17, cri_18, 'BURGLARY')
print("The change of burglary is {}%.".format(round(change_burglary, 2)))

change_mvt = compute_change(cri_17, cri_18, 'MOTOR VEHICLE THEFT')
print("The change of motor vehicle theft is {}%.".\
                                format(round(change_mvt, 2)))
