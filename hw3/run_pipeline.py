...
# First dataset is separated by the timestamps 2012-07-01 and 2013-01-01
train1, test1, train_target1, test_target1 = \
        pl.temporal_validation(df, predictors, '60daysfunded',\
                                'date_posted', '2012-07-01', '2013-01-01')
# Second dataset is separated by the timestamps 2013-01-01 and 2013-07-01
train2, test2, train_target2, test_target2 = \
        pl.temporal_validation(df, predictors, '60daysfunded',\
                                'date_posted', '2013-01-01', '2013-07-01')
# Third dataset is separated by the timestamp 2013-07-01 and 2013-12-31
train3, test3, train_target3, test_target3 = \
        pl.temporal_validation(df, predictors, '60daysfunded',\
                                'date_posted', '2013-07-01', '2013-12-31')
